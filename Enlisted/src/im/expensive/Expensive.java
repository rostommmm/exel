...
public class Expensive {
    ...
    private void initStyles() {
        ...
        styles.add(styleFactory.createStyle("Темно фиолетовый", new Color(0, 0, 0), new Color(84, 0, 179)));
        ...
        styles.add(styleFactory.createStyle("Металлический", new Color(0, 0, 0), new Color(255, 255, 255)));
        styles.add(styleFactory.createStyle("Черно белый", new Color(82, 241, 171), new Color(66, 172, 245)));
