...
public class BindComponent extends Component {
    ...
    public void render(MatrixStack stack, float mouseX, float mouseY) {
        ...
        DisplayUtils.drawRoundedRect(getX() + 5, getY() + 9,Fonts.montserrat.getWidth(bind, 5.5f, activated ? 0.1f : 0.05f) + 4, 5.5f + 4, 2, ColorUtils.rgba(25, 26, 40, 45), true, false, true, false);
