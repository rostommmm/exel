...
public class TargetInfoRenderer implements ElementRenderer {
    ...
    private final ResourceLocation kirka = new ResourceLocation("expensive/images/kirka.png");
    ...
    public void render(EventDisplay eventDisplay) {
        ...
        if (entity != null) {
            ...
            DisplayUtils.drawShadow(posX - 1, posY - 1, width - 10, height - 10, 10, ColorUtils.rgba(32,35,90,128));
            DisplayUtils.drawRoundedRect(posX - 1, posY - 1, width - 10, height - 10, 4, ColorUtils.rgba(0,0,0,156));
            DisplayUtils.drawShadow(posX + 23, posY + 37, width - 34, 10, 4, ColorUtils.rgba(32,35,90,128));
            DisplayUtils.drawRoundedRect(posX + 23, posY + 37, width - 34, 10, 4, ColorUtils.rgba(0,0,0,156));
            DisplayUtils.drawShadow(posX + 0, posY + 37, textWidth + 7, 10, 4, ColorUtils.rgba(32,35,90,128));
            DisplayUtils.drawRoundedRect(posX + 0, posY + 37, textWidth + 7, 10, 4, ColorUtils.rgba(0,0,0,156));
            Fonts.montserrat.drawText(ms, ((int) hp + (int) mc.player.getAbsorptionAmount()) + "HP", posX + 3, posY + 39.5f , ColorUtils.getColor(0), 5f, 0.15f);
            ...
            drawItemStack(posX + headSize + 36, posY + 13, -12);
            Scissor.unset();
            Scissor.pop();

            DisplayUtils.drawRoundedRect(posX + 21 + spacing, posY + 9 + height - spacing * 2 - 3, (width - 40), 3, 1, ColorUtils.rgba(70, 70, 70, 255));

            DisplayUtils.drawRoundedRect(posX + 21 + spacing, posY + 9 + height - spacing * 2 - 3, (width - 40) * healthAnimation, 3, 1, ColorUtils.getColor(0));
    ...
    public static void drawItemStack(ItemStack stack, float x, float y, boolean withoutOverlay, boolean scale, float scaleValue) {
        ...
        mc.getItemRenderer().renderItemAndEffectIntoGUI(stack, 35, 5);
        if (withoutOverlay) mc.getItemRenderer().renderItemOverlays(mc.fontRenderer, stack, 35, 5);
    ...
    private void drawStyledRect(float x,
        ...
        DisplayUtils.drawRoundedRect(x, y, width, height + 6, (int) radius, ColorUtils.rgba(25, 26, 40, 205));
    }
}
