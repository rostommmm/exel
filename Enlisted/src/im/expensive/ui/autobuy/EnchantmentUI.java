...
public class EnchantmentUI implements IMinecraft {
    ...
    public void render(MatrixStack stack, float mouseX, float mouseY, float pt) {
        ...
        for (Enchantment enchantment : enchantmentsMap) {
            ...
            DisplayUtils.drawRoundedRect(x + 5, y + 5 + i * (size + 10) + 10 + scroll, width - 10, 3, 1, ColorUtils.rgba(25, 25, 25, 255), true, false, true, false);
            ...
            DisplayUtils.drawRoundedRect(x + 5, y + 5 + i * (size + 10) + 10 + scroll, animations.get(enchantment), 3, 1, ColorUtils.getColor(0), true, false, true, false);
            i++;
        }
