...
public class AutoBuyUI extends Screen implements IMinecraft {
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        DisplayUtils.drawRoundedRect(x + 10, y + height - 60, width - 20, 50, 4, ColorUtils.rgba(23, 23, 23, 255), true, false, true, false);
        ...
        if (selecting) {
            ...
            DisplayUtils.drawRoundedRect(x + 5, itemY, width - 10, 28, 3, ColorUtils.rgba(23, 23, 23, 255), true, false, true, false);
            ...
            for (AutoBuy buy : Expensive.getInstance().getAutoBuyHandler().items) {
                ...
                DisplayUtils.drawRoundedRect(x + 10 + buyX, y + 10 + buyY, widthPanel, 50, 3, ColorUtils.rgba(23, 23, 23, 255), true, false, true, false);
                DisplayUtils.drawRoundedRect(x + 15 + buyX, y + 15 + buyY, 20, 20, 3, ColorUtils.rgba(30, 30, 30, 255), true, false, true, false);
