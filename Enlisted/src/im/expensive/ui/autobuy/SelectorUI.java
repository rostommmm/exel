...
public class SelectorUI implements IMinecraft {
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        DisplayUtils.drawRoundedRect(x, y, 100, 100, 4, ColorUtils.rgba(17, 17, 17, 255), true, false, true, false);
        ...
        DisplayUtils.drawRoundedRect(x + 5, y + 100 - 20, 100 - 10, 15, 3, ColorUtils.rgba(27, 27, 27, 255), true, false, true, false);
        ...
        DisplayUtils.drawRoundedRect(x + 7, y + 30, 50, 11, 2, ColorUtils.rgba(27, 27, 27, 255), true, false, true, false);
        ...
        if (Block.getBlockFromItem(selected) instanceof ShulkerBoxBlock b) {
            ...
            DisplayUtils.drawRoundedRect(x + 8 - 2, y + 23 + 28 - 2 + 0.5f, Fonts.montserrat.getWidth(don ? "Да" : "Нет", 6, 0.03f) + 4.5f, 5 + 4, 2, ColorUtils.rgba(25, 25, 25, 255), true, false, true, false);
            ...
            DisplayUtils.drawRoundedRect(x + 8 - 2, y + 23 + 28 - 2 + 0.5f + 17, Fonts.montserrat.getWidth(items ? "Да" : "Нет", 6, 0.03f) + 4.5f, 5 + 4, 2, ColorUtils.rgba(25, 25, 25, 255), true, false, true, false);
            ...
            DisplayUtils.drawRoundedRect(x + 7, y + 30 + 20, 20, 8, 2, ColorUtils.rgba(27, 27, 27, 255), true, false, true, false);
            ...
            DisplayUtils.drawRoundedRect(x + 8 - 2, y + 23 + 28 - 2 + 0.5f + 17, Fonts.montserrat.getWidth(fake ? "Да" : "Нет", 6, 0.03f) + 4.5f, 5 + 4, 2, ColorUtils.rgba(25, 25, 25, 255), true, false, true, false);
