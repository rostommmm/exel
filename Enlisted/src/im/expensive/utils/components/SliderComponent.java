...
//        Fonts.montserrat.drawText(stack, String.valueOf(current),x + Fonts.montserrat.getWidth(name, 6) + 5 + 1f, y + 1f, -1,5);
        ...
        DisplayUtils.drawRoundedRect(x,y + 7,width,height - 7, 1, ColorUtils.rgba(27, 27, 27, 255), true, false, true, false);
        DisplayUtils.drawRoundedRect(x,y + 7,widthSlider,height - 7, 1, ColorUtils.getColor(0), true, false, true, false);
