...
public class FieldComponent {
    ...
    public void draw(MatrixStack stack, float mouseX, float mouseY) {
        if (hide) {
            DisplayUtils.drawRoundedRect(x,y,width,height, 1, MathUtil.isHovered(mouseX,mouseY,x,y,width,height) ? ColorUtils.rgba(31, 31, 31, 255) : ColorUtils.rgba(27, 27, 27, 255), true, false, true, false);
        ...
        DisplayUtils.drawRoundedRect(x,y + 7,width,height - 7, 3, MathUtil.isHovered(mouseX,mouseY,x,y + 7,width,height - 7) ? ColorUtils.rgba(31, 31, 31, 255) : ColorUtils.rgba(27, 27, 27, 255), true, false, true, false);
