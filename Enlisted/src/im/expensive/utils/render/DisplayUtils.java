...
public class DisplayUtils implements IMinecraft {
    ...
    public static void drawRoundedRect(float x,
        ...
        ShaderUtil.rounded.setUniform("round", vector4f * 2, vector4f * 2, vector4f * 2, vector4f * 2);
    ...
    public static void drawRoundedRect(float x,
                                       ...
                                       float height,
                                       float radius,
                                       int color, boolean b, boolean b1, boolean b2, boolean b3) {
        GlStateManager.pushMatrix();
        GlStateManager.enableBlend();
    ...
    public static void drawCircle(float x, float y, float radius, int color) {
        drawRoundedRect(x - radius / 2f, y - radius / 2f, radius, radius,
                radius / 2f, color, true, false, true, false);
    }
    ...
    public static void drawRoundedBox(float v, float v1, float v2, float v3, int i, int i1, int rgba) {
    }

    public static void drawRoundedBoxTest(float x, float y, float z, float w, int i, Vector4i vector4i, int i1) {

    }

    public static void drawRoundedBox(float x, float y, float z, float w, float h, int radius, int color) {
        GL11.glPushMatrix();
        GL11.glTranslatef(x, y, z);
        GL11.glScalef(w, h, 1);

        GL11.glBegin(GL11.GL_QUADS);
        GL11.glColor4f((float) (color >> 16) / 255, (float) (color >> 8) / 255, (float) (color) / 255, (float) (color >> 24) / 255);
        ...
        // Верхний правый угол
        GL11.glVertex2f(1 - radius, -radius);
        GL11.glVertex2f(1 + radius, -radius);
        GL11.glVertex2f(1 + radius, radius);
        GL11.glVertex2f(1 - radius, radius);

        // Нижний правый угол
        GL11.glVertex2f(1 - radius, 1 - radius);
        GL11.glVertex2f(1 + radius, 1 - radius);
        GL11.glVertex2f(1 + radius, 1 + radius);
        GL11.glVertex2f(1 - radius, 1 + radius);

        // Нижний левый угол
        GL11.glVertex2f(-radius, 1 - radius);
        GL11.glVertex2f(radius, 1 - radius);
        GL11.glVertex2f(radius, 1 + radius);
        GL11.glVertex2f(-radius, 1 + radius);
    ...
    public static void drawRoundedRect(float x, float y, float width, float height, Vector4f vector4f, int rgba) {
    }
}