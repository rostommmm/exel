...
public class StorageESP extends Function {
    ...
    private final Map<TileEntityType<?>, Integer> tiles = new HashMap<>(Map.of(
            new ChestTileEntity().getType(), new Color(96, 56, 0).getRGB(),
            new TrappedChestTileEntity().getType(), new Color(143, 109, 62).getRGB(),
            new BarrelTileEntity().getType(), new Color(92, 41, 11).getRGB(),

            new HopperTileEntity().getType(), new Color(126, 126, 126).getRGB(),
            ...
            new EnderChestTileEntity().getType(), new Color(31, 0, 115).getRGB(),
